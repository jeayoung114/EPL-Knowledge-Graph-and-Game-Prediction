...
obj_test_mrr, obj_test_hits1, obj_test_hits3, obj_test_hits5, obj_test_hits10, obj_test_hits15 = 0, 0, 0, 0, 0, 0
...
for idx in range(n_batch):
    ...
    if args.raw:
        tim_mrr, tim_hits1, tim_hits3, tim_hits5, tim_hits10, tim_hits15 = calc_raw_mrr(test_score, test_label, hits=[1, 3, 5, 10, 15])
    else:
        tim_mrr, tim_hits1, tim_hits3, tim_hits5, tim_hits10, tim_hits15 = calc_filtered_test_mrr(num_e, test_score,
                                                                           torch.LongTensor(
                                                                               train_data),
                                                                           torch.LongTensor(
                                                                               dev_data),
    ...
    obj_test_hits15 += tim_hits15 * len(test_batch_data)
...
obj_test_hits15 = obj_test_hits15 / test_data.shape[0]

print("test object-- Epoch {:04d} | Best MRR {:.4f} | Hits@1 {:.4f} | Hits@3 {:.4f} | Hits@5 {:.4f} | Hits@10 {:.4f} | Hits@15 {:.4f}".
      format(checkpoint_obj['epoch'], obj_test_mrr, obj_test_hits1, obj_test_hits3, obj_test_hits5, obj_test_hits10, obj_test_hits15))
...
sub_test_mrr, sub_test_hits1, sub_test_hits3, sub_test_hits5, sub_test_hits10, sub_test_hits15 = 0, 0, 0, 0, 0, 0
n_batch = (test_data.shape[0] + batch_size - 1) // batch_size
...
for idx in range(n_batch):
    ...
    sub_test_hits5 += tim_hits5 * len(test_batch_data)
    sub_test_hits10 += tim_hits10 * len(test_batch_data)
    sub_test_hits15 += tim_hits15 * len(test_batch_data)
...
sub_test_hits5 = sub_test_hits5 / test_data.shape[0]
sub_test_hits10 = sub_test_hits10 / test_data.shape[0]
sub_test_hits15 = sub_test_hits15 / test_data.shape[0]

print("test subject-- Epoch {:04d} | Best MRR {:.4f} | Hits@1 {:.4f} | Hits@3 {:.4f} | Hits@5 {:.4f} | Hits@10 {:.4f} | Hits@15 {:.4f}".
      format(checkpoint_sub['epoch'], sub_test_mrr, sub_test_hits1, sub_test_hits3, sub_test_hits5, sub_test_hits10, sub_test_hits15))
...
test_hits5 = (obj_test_hits5 + sub_test_hits5) / 2
test_hits10 = (obj_test_hits10 + sub_test_hits10) / 2
test_hits15 = (obj_test_hits15 + sub_test_hits15) / 2

print("\n\nfinal test --| Best MRR {:.4f} | Hits@1 {:.4f} | Hits@3 {:.4f} | Hits@5 {:.4f} | Hits@10 {:.4f} | Hits@15 {:.4f}".
      format(test_mrr, test_hits1, test_hits3, test_hits5, test_hits10, test_hits15))
